# SkynetAccessibility Video Title
...
Follow the steps below to install the **SkynetAccessibility Video Subtitle** module for Craft CMS.
...
Make sure you are in the **root folder** of your Craft CMS project.
...
```bash```
composer require skynettechnologies/craft-skynet-accessibility-videosubtitle
php craft plugin/install craft-skynet-accessibility-videosubtitle
...
| `https://img.youtube.com`          | YouTube Thumbnail Service           | Loading YouTube video thumbnail images       |
| `https://www.youtube.com`          | YouTube                             | Embedded YouTube video playback (iframe)     |
...
![SkynetAccessibility_Video Subtitle_Image_1](https://www.skynettechnologies.com/sites/default/files/SkynetAccessibilityVideoSubtitle/SkynetAccessibility_Video_Subtitle_Image_1.jpg)  
![SkynetAccessibility_Video Subtitle_Image_2](https://www.skynettechnologies.com/sites/default/files/SkynetAccessibilityVideoSubtitle/SkynetAccessibility_Video_Subtitle_Image_2.jpg)
![SkynetAccessibility_Video Subtitle_Image_3](https://www.skynettechnologies.com/sites/default/files/SkynetAccessibilityVideoSubtitle/SkynetAccessibility_Video_Subtitle_Image_3.jpg)
